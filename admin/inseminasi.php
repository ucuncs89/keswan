...
<?php include 'header.php'; ?>
  ...
  $query=mysql_query("SELECT * FROM tbl_inseminasi WHERE status_ib ='pengajuan'");
...
?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="prosesinseminasi.php?id=<?php echo $data['id_inseminasi']; ?>"class="btn btn-simple btn-info btn-icon"><i class="material-icons">edit</i></a>
                                                    </td>
                                                </tr>
<?php }?>
                                            </tbody>
