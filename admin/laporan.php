...
echo("<script language='javascript'>
    window.location.href='printkesehatan.php?dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='inseminasi') {
echo("<script language='javascript'>
    window.location.href='printinseminasi.php?dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='kelahiran') {
echo("<script language='javascript'>
    window.location.href='printkelahiran.php?dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='vaksinasi') {
echo("<script language='javascript'>
    window.location.href='printvaksinasi.php?dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
