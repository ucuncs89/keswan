...
if (isset($_POST['submit'])) { 
        extract($_POST);   
        $login = $user->check_login($id_admin, $password_admin);
        if ($login) {
...
<head>
  <meta charset="UTF-8">
  <title>KESWAN | Login Admin</title>
...
<body>
  ...
  <form method="post" name="login">
	<div class="svgContainer">
		...
		<center><font size="12">Login | Admin</font></center>
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Id Admin</label>
		<input type="text" id="loginEmail" maxlength="254" name="id_admin" />
		
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_admin" />
