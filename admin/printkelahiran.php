...
<table id="example" class="display nowrap" cellspacing="0" width="100%">  
  ...
  $query=mysql_query("SELECT tbl_kelahiran.*, tbl_user.*, tbl_petugas.*
FROM ((tbl_kelahiran
INNER JOIN tbl_user ON tbl_kelahiran.username_user = tbl_user.username_user)
INNER JOIN tbl_petugas ON tbl_kelahiran.id_petugas = tbl_petugas.id_petugas) WHERE tgl_pkb BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
