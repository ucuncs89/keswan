...
<table id="example" class="display nowrap" cellspacing="0" width="100%">  
  ...
  $query=mysql_query("SELECT tbl_periksa.*, tbl_user.*, tbl_petugas.*
FROM ((tbl_periksa
INNER JOIN tbl_user ON tbl_periksa.username_user = tbl_user.username_user)
INNER JOIN tbl_petugas ON tbl_periksa.id_petugas = tbl_petugas.id_petugas) WHERE tgl_periksa BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
