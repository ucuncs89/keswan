                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Pilih Petugas Inseminasi Buatan</h4>
...
$sql = "UPDATE `tbl_inseminasi` SET `id_petugas` = '$id_petugas', `status_ib` = 'proses' WHERE `tbl_inseminasi`.`id_inseminasi` = '$id_inseminasi';";
...
echo("<script language='javascript'>
    ...
    window.location.href='prosesinseminasi.php?id=$id_periksa';
    </script>");
}
}
?>