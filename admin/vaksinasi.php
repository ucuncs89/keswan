...
<?php include 'header.php'; ?>
  ...
  $query=mysql_query("SELECT * FROM tbl_vaksinasi WHERE status ='pengajuan'");
...
?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="prosesvaksinasi.php?id=<?php echo $data['id_vaksinasi']; ?>" class="btn btn-simple btn-info btn-icon"><i class="material-icons">edit</i></a>
                                                    </td>
                                                  </tr>
<?php }?>
                                            </tbody>
