...
session_start();
    ...
    $xid_petugas = $_SESSION['id_petugas'];
...
<body>
    <div class="wrapper">
        <div class="sidebar fixed-top" data-active-color="red" data-background-color="black">
            <div class="logo">
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    <div class="photo">
                        <img src="../assets/img/petugas.png" />
                    </div>
                    <div class="info">
                        <a data-toggle="collapse" href="#collapseExample" class="collapsed">
                            <?php echo $xid_petugas; ?>
                            <b class="caret"></b>
                        </a>
