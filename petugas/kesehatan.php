...
<?php include 'header.php'; ?>
  ...
  $query=mysql_query("SELECT * FROM tbl_periksa WHERE id_petugas = '$xid_petugas' and status !='pengajuan'");
...
?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                       ...
                                                       <a href="proseskesehatan.php?id=<?php echo $data['id_periksa'];?>&id_hewan=<?php echo $data['id_hewan'];?>&username_user=<?php echo $data['username_user'];?>"class="btn btn-simple btn-danger btn-icon"><i class="material-icons">edit</i></a>
