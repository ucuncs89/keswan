...
if (isset($_POST['submit'])) { 
        extract($_POST);   
        $login = $user->check_login($id_petugas, $password_petugas);
        if ($login) {
...
<head>
  <meta charset="UTF-8">
  <title>Keswan | Login Petugas</title>
...
<body>
  ...
  <form method="post" name="login">
	<div class="svgContainer">
		...
		<center><font size="12">Login | Petugas</font></center>
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Id Petugas</label>
		<input type="text" id="loginEmail" maxlength="254" name="id_petugas" required="required" />
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_petugas" required="required" />
