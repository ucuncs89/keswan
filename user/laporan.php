                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="username_user" value="<?php echo $xusername_user;?>">
...
echo("<script language='javascript'>
    window.location.href='printkesehatan.php?username_user=$username_user&dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='inseminasi') {
echo("<script language='javascript'>
    window.location.href='printinseminasi.php?username_user=$username_user&dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='kelahiran') {
echo("<script language='javascript'>
    window.location.href='printkelahiran.php?username_user=$username_user&dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
    if ($jenis_laporan=='vaksinasi') {
echo("<script language='javascript'>
    window.location.href='printvaksinasi.php?username_user=$username_user&dari_tanggal=$dari_tanggal&sampai_tanggal=$sampai_tanggal';
    </script>");
    }
