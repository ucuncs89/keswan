...
if (isset($_POST['submit'])) { 
        extract($_POST);   
        $login = $user->check_login($username_user, $password_user);
        if ($login) {
...
<body>
  ...
  <form method="post" name="login">
	<div class="svgContainer">
		...
		<center><font size="12">Login | User</font></center>
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Username</label>
		<input type="text" id="loginEmail" maxlength="254" name="username_user" required="required" />
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="password_user" required="required" />
		<label id="showPasswordToggle" for="showPasswordCheck">Show
			<input id="showPasswordCheck" type="checkbox"/>
			<div class="indicator"></div>
		</label>
		<br>
		<label><a href="register.php">Belum Punya Akun Daftar Disini</a></label>
	</div>
	<div class="inputGroup inputGroup3">
		<button id="login" name="submit">Log in</button>
	</div>	
</form>
